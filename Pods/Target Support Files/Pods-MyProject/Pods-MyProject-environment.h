...
// HLLibrary
#define COCOAPODS_POD_AVAILABLE_HLLibrary
#define COCOAPODS_VERSION_MAJOR_HLLibrary 0
#define COCOAPODS_VERSION_MINOR_HLLibrary 1
#define COCOAPODS_VERSION_PATCH_HLLibrary 2
